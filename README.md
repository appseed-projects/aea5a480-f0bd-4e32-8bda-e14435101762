...
- Timestamp: `2022-06-08 05:25`
- Build ID: `aea5a480-f0bd-4e32-8bda-e14435101762`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/aea5a480-f0bd-4e32-8bda-e14435101762.git
$ cd aea5a480-f0bd-4e32-8bda-e14435101762
```
